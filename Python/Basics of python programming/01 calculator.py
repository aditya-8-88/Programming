...
print(2**.5) #here square root like  Math.root(a,b) type
print(round( 2**.5 , 4)) #round off to 4th decimal place of the floating answer
print(3%2) #just like java modulus
print(2**3**2**2) #exponent here:- (2**3**4)= (2**81)=answer